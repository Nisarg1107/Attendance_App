...
public class p_a_210 extends AppCompatActivity {

    private static final String TAG = "p_a_210";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_a_210);
        ...
        databaseStudent= FirebaseDatabase.getInstance().getReference("EC210");
