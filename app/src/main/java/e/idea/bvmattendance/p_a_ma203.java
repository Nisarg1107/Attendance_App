...
public class p_a_ma203 extends AppCompatActivity {

    private static final String TAG = "p_a_ma203";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_a_ma203);
        ...
        databaseStudent= FirebaseDatabase.getInstance().getReference("MA203");
