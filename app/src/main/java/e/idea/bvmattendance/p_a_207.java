...
public class p_a_207 extends AppCompatActivity {

    private static final String TAG = "p_a_207";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_a_207);
        ...
        databaseStudent= FirebaseDatabase.getInstance().getReference("EC207");
