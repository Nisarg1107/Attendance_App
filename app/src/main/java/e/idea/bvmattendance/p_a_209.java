...
public class p_a_209 extends AppCompatActivity {

    private static final String TAG = "p_a_209";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_a_209);
        ...
        databaseStudent= FirebaseDatabase.getInstance().getReference("EC209");
