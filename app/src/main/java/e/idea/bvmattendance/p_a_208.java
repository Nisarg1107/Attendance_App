...
public class p_a_208 extends AppCompatActivity {

    private static final String TAG = "p_a_208";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_a_208);
        ...
        databaseStudent= FirebaseDatabase.getInstance().getReference("EC208");
